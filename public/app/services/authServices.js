...
// Factor: Auth handles all login/logout functions	
    ...
    {
        let authFactory = {}; // Create the factory object
    ...
    {
        let authTokenFactory = {}; // Create factory object
    ...
    {
        let authInterceptorsFactory = {}; // Create factory object

        // Function to check for token in local storage and attach to header if so
        authInterceptorsFactory.request = function (config)
        {
            let token = AuthToken.getToken(); // Check if a token is in local storage
            if (token)
